	...
	export default {
		...
		methods: {
			a1() {
				...
				var ruleafter = CSSRulePlugin.getRule(".loaderline:after"); //get the rule
				var rulebefore = CSSRulePlugin.getRule(".loaderline:before"); //get the rule
				...
				// tl.seek(1.5);
				// tl.reverse();
//transform-origin: center bottom 0px; transform: matrix(1, 0, 0, 1, 0, 0);
			}
		},
		mounted() {
			this.a1()
